...
public class PurchaseRepositoryTest {
    ...
    @Before
    public void setUp() {
        Customer customer = CustomerDataBuilder.anObject().withName(CUSTOMER_NAME).build();
    ...
    public void mustFindById() {
        ...
        assertThat(object.get().getCustomer().getName(), is(equalTo(CUSTOMER_NAME)));
    }

    @Test
    public void mustNotFindById() {
        Optional<Address> object = repository.findById(INVALID_PARAM_ID);
    ...
    public void mustFindAllItems() {
        List<Address> objects = repository.findAll();
        assertThat(objects.get(0).getCustomer().getName(), is(equalTo(CUSTOMER_NAME)));
    }
    ...
    public void mustSaveAnItem() {
        ...
        assertThat(savedObject.getCustomer().getName(), is(equalTo(CUSTOMER_NAME)));
    }
