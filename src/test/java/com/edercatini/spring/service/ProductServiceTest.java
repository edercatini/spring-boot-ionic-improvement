...
public class ProductServiceTest extends ServiceTest {
    ...
    public void mustFindById() {
        ...
        CustomResponse<Product> object = service.findById(PARAM_ID);
    ...
    public void mustFindByPage() {
        ...
        Page<Product> objects = service.findByPage(PAGE, SIZE, DIRECTION, PROPERTIES);
    ...
    public void mustSaveAnObject() {
        ...
        CustomResponse<Product> object = service.save(anObject().build());
        assertTrue(object.getEntity() instanceof Product);
        assertThat(object.getEntity().getName(), is(equalTo(OBJECT_NAME)));
    }
